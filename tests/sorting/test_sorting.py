...
def test_sort_by_criteria():
    ...
    assert jobs_mock == jobs_mock_max_salary

    sort_by(jobs_mock, "min_salary")
    assert jobs_mock == jobs_mock_min_salary

    sort_by(jobs_mock, "date_posted")
    assert jobs_mock == jobs_mock_date_posted
